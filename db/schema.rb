...
ActiveRecord::Schema.define(version: 20191130141803) do
  ...
  create_table "clinic_notifications", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.integer "clinic_id"
    t.integer "category"
    t.integer "patient_id"
    t.string "args"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["clinic_id"], name: "index_clinic_notifications_on_clinic_id"
  end
  ...
  create_table "clinics", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    ...
    t.datetime "clinic_notifications_read_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "event_notifications", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    ...
    t.integer "line_sending_id"
    t.integer "notification_template_id"
    t.integer "notification_schedule_id"
    t.integer "status", limit: 1, default: 0
    t.string "args"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
